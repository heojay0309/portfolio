    ...
    return (
        <div className={styles.gridContainer}>
            ...
            <div className={styles.grid2}>
                ...
                <h6 className={styles.font}>React/Redux, Jest, Node.js, Express, PostgreSQL </h6>
                <Image src={LockedOut2} />
                <Image src={LockedOut1} />
            </div>
            <div className={styles.grid3}>
                <a className={styles.a} href='https://github.com/Team-API-Reference/uSPOT'>uSPOT </a>
                <h6 className={styles.font}>React, Node.js, Jest, Chrome Extension, Express, PostgreSQL </h6>
                <Image src={uSPOT} />
            </div>
            <div className={styles.grid4}>
                <a className={styles.a} href='https://github.com/jayjonathantrevorleonard/unbEATable'>unbEATable </a>
                <h6 className={styles.font}>React/Redux, Node.js, Express, MongoDB </h6>
